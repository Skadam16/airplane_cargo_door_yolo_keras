...
from backend import TinyYoloNetwork, FullYoloNetwork
...
class YOLO(object):
    def __init__(self, architecture,
        ...
        if architecture == 'Full Yolo':
            self.feature_extractor = FullYoloNetwork(self.input_size, weights_path = pretrained_weights)
        elif architecture == 'Tiny Yolo':
            self.feature_extractor = TinyYoloNetwork(self.input_size, weights_path = pretrained_weights)
        else:
            raise Exception('Architecture not supported! Only support Full Yolo, Tiny Yolo at the moment!')

        #print out model and info
